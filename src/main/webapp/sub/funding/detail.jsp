         ...
         %>  
            ...
            %>  
						...
						<li class="goal_info">
							...
							<div class="prog_bar">
								<%
									int percent = Integer.parseInt(funding.getRased_amount()) * 100 / Integer.parseInt(funding.getGoal_amount());
									if(percent > 100){
										percent = 100;
									}
								%>
								<strong style="display block; width: <%= percent %>%;"></strong>
							</div>
						...
						<li class="reward_choose">
			            	...
			            	if(funding.getStatus().equals("진행중")){
			            		...
			            		%>
			            		<button type="button" style="color: #fff; background-color: #ddd;">펀딩 종료</button>
