...
<body>
			...
			<section id="item_list_wrap">
				...
				<div class="filter_box">
					<a href="./notice_write.jsp" class="funding_write writeBtn">공지
						등록</a>
					<!-- <a href="./notice_delete_all.jsp" class="funding_write del">선택돼
						있는 게시글(들)을 전부 다 삭제</a> -->
				</div>
				...
				<form action="deleteBoards" method="post">
					...
					<table>
						...
						<tr class="table_header">
							<th scope="row"><input type="checkbox" id="selectAll"
            ...
            form.submit();
				...
				<ol>
					<li>
						...
						if (nowPage > 1) {
						%> <a href="manager_notice.jsp?nowPage=<%=nowPage - 1%>"> <span
							class="prev">이전</span>
					</a> <%
 } else {
 %> <a href="manager_notice.jsp?nowPage=<%=nowPage%>"> <span
 ...
 %>
						...
						<div class="page">
							...
							%>
							<a href="manager_notice.jsp?nowPage=<%=i%>"
								<%if (i == nowPage) {
